...
INSERT INTO ASYNC.ATTACHMENT (ATT_ID , ATT_REQ_ID , NAME ,CONTENT_TYPE ,BODY ) VALUES ('hex13-1', 'test13', 'test13-file1', 'image/jpg', 'body of jpgx');
INSERT INTO ASYNC.ATTACHMENT (ATT_ID , ATT_REQ_ID , NAME ,CONTENT_TYPE ,BODY ) VALUES ('hex13-2', 'test13', 'test13-file2', 'image/jpg','body of jpg');
INSERT INTO ASYNC.ATTACHMENT (ATT_ID , ATT_REQ_ID , NAME ,CONTENT_TYPE ,BODY ) VALUES ('hex13-3', 'test13', 'test1-file3', 'image/jpg','body of jpg');


INSERT INTO ASYNC.REQUEST (REQ_ID, USER_NAME, ACTION, PARAMETERS, SCHEDULE_NAME, STATUS, ATTEMPT, EXECUTION_RETRIES,RETRY_INTERVAL )
VALUES( 'test14', 'max', 'test-action5', 'test paramter 2', '', 'N', '10','10', '300');

INSERT INTO ASYNC.ATTACHMENT (ATT_ID , ATT_REQ_ID , NAME ,CONTENT_TYPE ,BODY ) VALUES ('hex14-1', 'test14', 'test14-file1', 'image/jpg','body of jpg');
INSERT INTO ASYNC.ATTACHMENT (ATT_ID , ATT_REQ_ID , NAME ,CONTENT_TYPE ,BODY ) VALUES ('hex14-2', 'test14', 'test14-file2', 'image/jpg','body of jpg');
INSERT INTO ASYNC.ATTACHMENT (ATT_ID , ATT_REQ_ID , NAME ,CONTENT_TYPE ,BODY ) VALUES ('hex14-3', 'test14', 'test14-file3', 'image/jpg','body of jpg');
