...
ALTER TABLE %SCHEMA%.RESPONCE ADD CONSTRAINT RESPONCE_FK FOREIGN KEY (RES_REQ_ID) REFERENCES %SCHEMA%.REQUEST(REQ_ID) ON DELETE CASCADE;
ALTER TABLE %SCHEMA%.ATTACHMENT ADD CONSTRAINT ATTACHMENT_FK FOREIGN KEY (ATT_REQ_ID) REFERENCES %SCHEMA%.REQUEST(REQ_ID) ON DELETE CASCADE;
